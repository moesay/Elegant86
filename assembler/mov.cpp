...
InstRet Mov::process() {
    ...
    if(firstOpType == OperandType::MemAddr) {
        if(pointerType != Pointer::None)
            ...
            if(secondOpType == OperandType::Reg16 || secondOpType == OperandType::SegReg)
        ...
        if(pointerType != Pointer::None)
            ...
            if(firstOpType == OperandType::Reg16 || firstOpType == OperandType::SegReg)
    ...
    if(((firstOpType==OperandType::Reg16) && (secondOpType==OperandType::Reg16)) ||
        ...
        if((firstOp == "AL" || firstOp == "AX") && isHexValue(secondOp)) {
        ...
        if(destIsMemAddr) {
            ...
            else if(secondOpType == OperandType::Reg16 || secondOpType == OperandType::Reg8)
